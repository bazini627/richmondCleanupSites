...
ms.runCommands("../project-files/contraCostaCityLimits/BND_DCD_City_Limits.shp -proj EPSG:4326 -filter-fields NAME -filter NAME=='Richmond' -simplify dp 30% -o precision=.0001 format=geojson ../data/richmondCityLimits.json");
